...
use bevy::mesh::{Mesh, Mesh3d, MeshBuilder, Meshable};
use bevy::pbr::{MeshMaterial3d, StandardMaterial};
use bevy::transform::components::{GlobalTransform, Transform};
use bevy_pg_core::prelude::MainCamera;

use crate::transform_gizmo::{
    TransformGizmoAxis, TransformGizmoFocus, TransformGizmoMeshMarker,
    TransformGizmoMode, TransformGizmoRoot, TransformGizmoConfig, TransformGizmoState,
    ...
    VIEW_CIRCLE_MAJOR, VIEW_CIRCLE_MINOR, VIEW_RING_MAJOR, VIEW_RING_MINOR, effective_space, gizmo_rotation
};
    ...
    fn build(&self, app: &mut App) {
        app.add_systems(
            ...
            spawn_gizmo_meshes.run_if(
                bevy::ecs::schedule::common_conditions::resource_exists::<TransformGizmoConfig>,
            ),
        )
        .add_systems(
            PostUpdate,
...
fn update_gizmo_meshes(
    ...
    settings: Option<Res<TransformGizmoConfig>>,
    ...
    let (_cam, cam_tf) = camera.into_inner();
